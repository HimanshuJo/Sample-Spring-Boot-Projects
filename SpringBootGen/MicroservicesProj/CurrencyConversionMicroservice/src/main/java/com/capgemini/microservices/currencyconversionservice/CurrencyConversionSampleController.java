package com.capgemini.microservices.currencyconversionservice;
...
public class CurrencyConversionSampleController {
	...
	public CurrencyConversionSampleBean convertCurrency(@PathVariable String fromCurrency, 
		...
		ResponseEntity<CurrencyConversionSampleBean> responseEntity = 
		    new RestTemplate().
		    getForEntity("http://localhost:8000/currency-exchange-sample/fromCurrency/{fromCurrency}/toCurrency/{toCurrency}",
